...
public class Tray {
    ...
    public static void init() throws Exception {
        ...
        imageOnline = Toolkit.getDefaultToolkit().getImage(new File(GuiConfig.ICON_ONLINE).getAbsolutePath());
        imageOffline = Toolkit.getDefaultToolkit().getImage(new File(GuiConfig.ICON_OFFLINE).getAbsolutePath());
        popup = new PopupMenu();
     ...
     */
    public static void trayOffline() {
